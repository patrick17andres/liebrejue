...
export default function CarruselInfo() {

    return (
        <div className='flex flex-col md:flex-row'>
              <div className="mx-2 my-2 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <Image
                            src={Imagen1}
                            width={380}
